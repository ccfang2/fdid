...
> You may find a presentation of the paper in my YouTube [video](https://www.youtube.com/watch?v=h0KCv8y9Apw). Also, users can adjust their honest reference bands (see below) interactively via our [Shiny app](https://ccfang2.shinyapps.io/fdidHonestInference/).
